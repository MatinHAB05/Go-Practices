...
func X_Example_basic(b *rod.Browser) {
...
func X_Example_disable_headless_to_debug(b *rod.Browser) {
...
func X_Example_context_and_timeout(b *rod.Browser) {
	page := b.MustPage("https://github.com")
...
func X_Example_context_and_EachEvent(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_Example_error_handling(b *rod.Browser) {
	page := b.MustPage("https://mdn.dev")
...
func X_Example_search(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_Example_page_screenshot(b *rod.Browser) {
	page := b.MustPage("https://github.com").MustWaitLoad()
...
func X_Example_page_scroll_screenshot(b *rod.Browser) {
	browser := b
...
func X_Example_page_pdf(b *rod.Browser) {
	page := b.MustPage("https://github.com").MustWaitLoad()
...
func X_Example_race_selectors(b *rod.Browser) {
	const username = ""
	const password = ""
...
func X_Example_wait_for_animation(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_Example_wait_for_request(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_Example_customize_retry_strategy(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_Example_direct_cdp(b *rod.Browser) {
	page := b.MustPage()
...
func X_Example_handle_events(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_Example_download_file(b *rod.Browser) {
	browser := b
...
func X_Example_hijack_requests(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_Example_eval_reuse_remote_object(b *rod.Browser) {
	page := b.MustPage()
...
func X_Example_states(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_ExamplePage_pool(b *rod.Browser) {
	browser := b
	defer browser.MustClose()
...
func X_ExampleBrowser_pool(b *rod.Browser) {
...
func X_Example_load_extension(b *rod.Browser) {
	...
	page := b.ControlURL(u).MustConnect().MustPage("http://mdn.dev")
...
func X_Example_log_cdp_traffic(b *rod.Browser) {
	cdp := cdp.New().
	...
	b.Client(cdp).MustConnect().MustPage("http://mdn.dev")
}

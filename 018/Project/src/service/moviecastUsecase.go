...
type MovieCast interface {
	...
	GetAllCastsOfMovie(movie_id int) ([]serviceparam.GetAllCastsOfMovieRespnse, error)
	GetAllMoviesOfCast(cast_id int) ([]serviceparam.GetAllMoviesOfCastRespnse, error)

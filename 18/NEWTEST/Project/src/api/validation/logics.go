...
func IsValudComparatorOperator(sign string) bool {
	return sign == appconstant.IsEqualSign || sign == appconstant.IsGreaterThanSign || sign == appconstant.IsLessThanSign ||
		sign == appconstant.IsGreaterEqualThanSign || sign == appconstant.IsLessEqualThanSing
}
